...
final public class VHSTrackingEffectFilter: BasicRenderFilter {

    private var timer: Float = 0

    public init() {
        super.init(fragmentFuncName: .vhsTracking)
...
// https://www.shadertoy.com/view/XtKXR1
