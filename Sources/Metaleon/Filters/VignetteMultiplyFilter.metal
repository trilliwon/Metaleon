...
float blend_3(float base, float blend) {
    return base * blend;
}

fragment float4 vignetteMultiplyFilter(VertexIO         inputFragment [[ stage_in ]],
                                      ...
                                      constant AlphaUniform& uniform [[ buffer(1) ]])
{
    ...
    float3 blendedColor = float3(blend_3(texColor.r, vignetteColor.r), blend_3(texColor.g, vignetteColor.g), blend_3(texColor.b, vignetteColor.b));
